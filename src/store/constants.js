...
export const PRESETS = [
	{
		...
		items: [
			...
			{
				id: 'ig-portrait',
				label: __( 'Instagram Portrait', 'wunderpaint' ),
				w: 1080,
				h: 1350,
			},
			{
				id: 'ig-story',
				label: __( 'Instagram Story / Reel', 'wunderpaint' ),
				w: 1080,
				h: 1920,
			},
			{
			...
			{
				id: 'fb-cover',
				label: __( 'Facebook Cover', 'wunderpaint' ),
				w: 820,
				h: 312,
			},
			{
				id: 'li-post',
				label: __( 'LinkedIn Post', 'wunderpaint' ),
				w: 1200,
				h: 627,
			},
			{
				id: 'li-banner',
				label: __( 'LinkedIn Banner', 'wunderpaint' ),
				w: 1584,
				h: 396,
			},
			{
				id: 'x-post',
				label: __( 'X Post', 'wunderpaint' ),
				w: 1600,
				h: 900,
			},
			{
				id: 'yt-thumb',
				label: __( 'YouTube Thumbnail', 'wunderpaint' ),
				w: 1280,
				h: 720,
			},
			{
				id: 'yt-banner',
				label: __( 'YouTube Banner', 'wunderpaint' ),
				w: 2560,
				h: 1440,
			},
			{
				id: 'pin',
				label: __( 'Pinterest Pin', 'wunderpaint' ),
				w: 1000,
				h: 1500,
			},
		],
	},
	{
		...
		items: [
			...
			{
				id: 'blog',
				label: __( 'Blog Featured Image', 'wunderpaint' ),
				w: 1200,
				h: 800,
			},
			{
			...
			{
				id: 'avatar',
				label: __( 'Profile Picture', 'wunderpaint' ),
				w: 512,
				h: 512,
			},
			{
				id: 'email',
				label: __( 'Email Header', 'wunderpaint' ),
				w: 600,
				h: 200,
			},
		],
	...
	{
		group: _x( 'Ads', 'preset group', 'wunderpaint' ),
		items: [
			{
				id: 'ad-leaderboard',
				label: __( 'Leaderboard', 'wunderpaint' ),
				w: 728,
				h: 90,
			},
			{
				id: 'ad-rect',
				label: __( 'Medium Rectangle', 'wunderpaint' ),
				w: 300,
				h: 250,
			},
			{
				id: 'ad-large',
				label: __( 'Large Rectangle', 'wunderpaint' ),
				w: 336,
				h: 280,
			},
			{
				id: 'ad-half',
				label: __( 'Half Page', 'wunderpaint' ),
				w: 300,
				h: 600,
			},
			{
				id: 'ad-sky',
				label: __( 'Wide Skyscraper', 'wunderpaint' ),
				w: 160,
				h: 600,
			},
			{
				id: 'ad-mobile',
				label: __( 'Mobile Banner', 'wunderpaint' ),
				w: 320,
				h: 100,
			},
		],
	...
	{
		group: _x( 'Print (300 DPI)', 'preset group', 'wunderpaint' ),
		items: [
			{
				id: 'a4',
				label: __( 'A4 Portrait', 'wunderpaint' ),
				w: 2480,
				h: 3508,
			},
			{
				id: 'a4-land',
				label: __( 'A4 Landscape', 'wunderpaint' ),
				w: 3508,
				h: 2480,
			},
			{
				id: 'a5',
				label: __( 'A5 Portrait', 'wunderpaint' ),
				w: 1748,
				h: 2480,
			},
			{
				id: 'a3',
				label: __( 'A3 Portrait', 'wunderpaint' ),
				w: 3508,
				h: 4961,
			},
			{
				id: 'letter',
				label: __( 'US Letter', 'wunderpaint' ),
				w: 2550,
				h: 3300,
			},
			{
				id: 'card',
				label: __( 'Business Card', 'wunderpaint' ),
				w: 1050,
				h: 600,
			},
			{
				id: 'postcard',
				label: __( 'Postcard (A6)', 'wunderpaint' ),
				w: 1748,
				h: 1240,
			},
		],
	...
	{
		group: _x( 'Screens', 'preset group', 'wunderpaint' ),
		items: [
			{
				id: '4k',
				label: __( '4K UHD', 'wunderpaint' ),
				w: 3840,
				h: 2160,
			},
			{
				id: 'desktop',
				label: __( 'Desktop Wallpaper', 'wunderpaint' ),
				w: 2560,
				h: 1440,
			},
			{
				id: 'phone',
				label: __( 'Phone Wallpaper', 'wunderpaint' ),
				w: 1170,
				h: 2532,
			},
			{
				id: 'slide',
				label: __( 'Presentation 4:3', 'wunderpaint' ),
				w: 1024,
				h: 768,
			},
		],
...
export const DEFAULT_TOOL_OPTS = {
	...
	zoom: {},
	move: {},
	marquee: { shape: 'rect', combine: 'replace', feather: 0 },
	lasso: { mode: 'freehand', combine: 'replace', feather: 0 },
	wand: { tolerance: 32, contiguous: true },
	pen: { mode: 'pen', fidelity: 50 },
	eyedropper: { sample: 1 },
	hand: {},
};
